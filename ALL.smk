...
config["bedfile"] = "/data/home2/hematopath/hemoseq_v2/mutation_detector/bedfile/ALL_coordinates_byexons.bed"
print("Working path", FILE_PATH, S3PATH)
print("bedfile: ", config["bedfile"])
...
include: "rules/finalout_nogetitd.smk"
